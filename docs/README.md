...
- `how-it-works.svg` / `.png` — **the engineering version.** Same flow with the barcode lookup waterfall, the API boundary, the Claude prompt rules, and the safe-verdict floor (too little text, or a cut-off ingredient list).
