...
- [x] Instrument OCR captures: `image_kb` + `ocr_chars` on `scan`/OCR `scan_failed` events — decides the capture-assist 1.4.1 fork (aiming vs blur) via failure-vs-success `image_kb` distributions; see `plans/ocr-capture-assist-2026-07-18.md` (PR #17, 2026-07-18)
