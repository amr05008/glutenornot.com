...
- The claim also covers oats. The same regulation holds a labeled product's oats to the 20 ppm limit, so a manufacturer making the claim is using purity-protocol or sorted-and-tested oats. With a whole-product claim or a certification mark (GFCO, CSA, "Certified Gluten-Free") present, oats do NOT lower the verdict: return "safe", name the label, and add one short clause that a small share of people with celiac disease react to oats themselves. (A claim written on the oats themselves — "gluten-free oats" inside the list — is not a whole-product claim; see below.)
