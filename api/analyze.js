...
Unnamed "natural flavors" / flavouring / aroma, "spices" / seasoning, maltodextrin, dextrin, modified (food) starch, glucose syrup, caramel color, and hydrolyzed vegetable/plant protein of unstated source (a named source such as "hydrolyzed soy protein" is not ambiguous either) — outside a meat or poultry product. Food-labeling law in the US, EU, UK, Canada, and Australia requires wheat to be named on the label wherever it is used, including inside these ingredients — in the ingredient list, or in a "Contains:" statement right after it — and EU/UK/Canadian/Australian law requires barley and rye too. Unnamed maltodextrin and glucose syrup are covered even where they may be wheat-based: they are processed to remove gluten, which is why EU law exempts them. One labeled with its wheat source ("glucose syrup (wheat)", "wheat maltodextrin") names wheat: judge it under "unsafe". If one of these is the only thing you might have worried about, and no "Contains"/allergen statement names wheat, barley, rye, or gluten, the verdict is "safe". You may add one short sentence saying why it is not a concern — never frame it as a risk.
