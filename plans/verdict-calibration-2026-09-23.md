...
| T3 | Meat and poultry products (sausage, hot dogs, deli meat, jerky, meatballs, marinated meat). US meat products are USDA-regulated, outside the FDA wheat-labeling law | `caution` / `undeclared_source` for their flavorings, spices, seasoning and hydrolyzed protein. It applies to any product made with meat or poultry, including soups, broths, chili and frozen meals (PR #32 grill). It also applies to non-US meat products: Aaron kept T3 global on 2026-09-24, although EU law already makes wheat be named there | treat them like any other product, or limit T3 to US products |
