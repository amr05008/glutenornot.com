...
- **Active plans**: `plans/` — scoped work-in-progress. **In build:** `barcode-recovery-2026-09-05.md` — barcode miss/no-data → neutral recovery state → photo-only capture, with the content-free `barcode_recovery` funnel (`POST /api/recovery`, contract in `api/ANALYTICS.md`). Server + client implemented 2026-09-05 on branch `barcode-recovery-2026-09-05`; device smoke, App Store privacy-label review, and the iOS release await Aaron's go. Enrichment (§8) deferred. Design export in `GlutenOrNot - V2 Designs/export090526/`; `plans/barcode-recovery-handoff-review-2026-09-05.md` records the approved overrides (content-free funnel kept; torch top-right / Recents bottom preserved over the export's notes). Two shipped 2026-08-28 with only their data reads left: `weak-signal-upload-2026-08-28.md` (PR #24 → iOS 1.4.3; D2 read ~2026-09-11, then close; next lever is toggle T2, multipart upload, as its own PR) and `gf-label-claim-2026-08-28.md` (PR #23, decision 003; step-9 read ~2026-09-25). `ocr-capture-assist-2026-07-18.md` is closed (2026-08-13) — read its CLOSED header before reopening the capture question
